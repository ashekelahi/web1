...
$(document).ready(function(){
    ...
    function validateEmail(email) {
      var re = /^[a-z0-9._%+-]+@(gmail.com|yahoo.com|live.com|hotmail.com)$/;
    ...
    $("form#submitFeedback").submit(function(){
      ...
      if(!$validEmail) {
          $('#error').html('Email address not valid !');
          return false;
      }
        ...
        $('.mobile-nav ul.levelone > li > span').off().on('click', function() {
            ...
            if ($(this).siblings('ul.leveltwo').hasClass('open')) {
                $('.mobile-nav ul.levelone > li > ul.open')
                    .slideUp('fast', function(){console.log('up');})
                    .removeClass('open')
                    .siblings('span')
                    .children('i')
                ...
                $(this).
                    ...
                    .addClass('open')
                    .slideDown('slow', function(){console.log('down');})
                    .siblings('span')
                    .children('i')
...
ga('create', 'UA-29905105-4', 'auto');
ga('send', 'pageview');

function LoopSlideshow(){
    objSlideContainer = document.getElementById('SlideContainer');
    objSlideContainer.style.marginLeft = objSlideContainer.style.marginLeft == '-575px' ? '0px' : '-575px';
}